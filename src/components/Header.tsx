            ...
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 border-t bg-white dark:bg-gray-900">
                ...
                <button
                  ...
                  className="flex items-center space-x-3 px-3 py-2 rounded-md text-base font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-800 transition-colors w-full text-left"
                >
                  <Search className="h-5 w-5" />
                  <span>검색</span>
                  <div className="ml-auto">
                    <kbd className="hidden sm:inline-block px-2 py-1 text-xs font-semibold text-gray-500 bg-gray-100 border border-gray-200 rounded dark:bg-gray-800 dark:text-gray-400 dark:border-gray-700">
                      ⌘K
                    </kbd>
                  </div>
                </button>
